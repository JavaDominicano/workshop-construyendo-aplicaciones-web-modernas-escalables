package org.javadominicano.workshop.views.login;
...
import org.javadominicano.workshop.security.AuthenticatedUser;
...
public class LoginView extends LoginOverlay implements BeforeEnterObserver {
    ...
    public LoginView(AuthenticatedUser authenticatedUser, CustomNotification notification) {
        ...
        i18n.getHeader().setTitle("WorkShop");
        ...
        addForgotPasswordListener(forgotPasswordEvent -> notification.notificationWarning("Coming Soon!"));
    }
